...
*/
      ...
      if(prev_check && !map.data[idx - map.info.width + 1] && !map.data[idx + 1] && !map.data[idx + map.info.width + 1])
      {
	...
	continue;
      ...
      if(!map.data[idx] && !map.data[idx - map.info.width - 1] && !map.data[idx - map.info.width] && !map.data[idx - map.info.width + 1] && !map.data[idx - 1] && !map.data[idx + 1] && !map.data[idx + map.info.width - 1] && !map.data[idx + map.info.width] && !map.data[idx + map.info.width + 1])
      {
